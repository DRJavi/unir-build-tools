JENKINS_DOCKER_AGENT_SECRET := 973b5f53e66a1ce2f706cb59993bf5b6123dca1e3b0fcd7b17281b74b3455537
JENKINS_MAVEN_AGENT_SECRET := 84e9afaa227445b780bb4a404cf42799a2c33622c0f68669f98f6f17d3eeffdc
...
start-jenkins:
	...
	docker run -d --rm --stop-timeout 60 --network jenkins --name jenkins-server --env DOCKER_HOST=tcp://docker:2376 --env DOCKER_CERT_PATH=/certs/client --env DOCKER_TLS_VERIFY=1 --volume jenkins-data:/var/jenkins_home --volume jenkins-docker-certs:/certs/client:ro -p 8080:8080 -p 55555:55555 jenkins/jenkins:2.249.2-lts-alpine
	sleep 30
